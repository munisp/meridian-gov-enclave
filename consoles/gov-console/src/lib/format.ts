// Meridian One §9 — Nigerian-context formatting utilities (shared module,
// identical in every Meridian app). Money is kobo integers end-to-end; never
// float-parse money inputs directly (use parseNGNToKobo / MoneyInput).
